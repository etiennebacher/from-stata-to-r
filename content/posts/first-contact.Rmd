...
That's it, we now have the complete dataframe. There are still some things to do. First, we remark that there are some errors in the column `location` (`England_error` and `Spain_error`) so we correct it:
...
That's it! In this first (long) post, you have seen how to import, clean and tidy datasets, and how to make some descriptive statistics and some plots. I hope this was helpful to you!
